...
GeoTIFF DEM files obtained from the [SRTM GL1 30m](https://portal.opentopography.org/raster?opentopoID=OTSRTM.082015.4326.1) tend to produce more accurate target results than DTED (per spec, DTED stores treetop height, not terrain height)
