...
//            appendLog("ERROR: Cannot calculate \uD83D\uDEAB\uD83E\uDDEE; no image \uD83D\uDEAB\uD83D\uDDBC selected\n");
        ...
        try {
            ...
            attribs += theMeta.getTagString(ExifInterface.TAG_FOCAL_LENGTH, exif) + " mm";
            attribs += theMeta.getTagString(ExifInterface.TAG_FOCAL_LENGTH_IN_35MM_FILM, exif) + " mm";
...
//            try {
//                relativeRay = theMeta.getRayAnglesFromImgPixel(3087, 1118, exif);
//            } catch (Exception e) {
//                relativeRay = new double[] {0.0d, 0.0d};
//            }
